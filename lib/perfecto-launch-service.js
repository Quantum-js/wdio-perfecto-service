    ...
    onPrepare (config, capabilities) {
        ...
        if (Array.isArray(capabilities)) {
            capabilities.forEach((capability) => {
                capability.user = capability.user || this.perfectoConnectOpts.user
            ...
            Object.keys(capabilities).forEach((browser) => {
                capabilities[browser].desiredCapabilities.user = capabilities[browser].desiredCapabilities.user || this.perfectoConnectOpts.user
